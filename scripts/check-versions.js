#!/usr/bin/env node
// Version-consistency guard. Ken declares its version in eight files across
// five host ecosystems, and every release bumps all of them by hand.
//
// Manifests can agree with each other while staying stale *together* as a
// release moves on, so mutual agreement alone is not enough. This check:
...
const VERSION_FILES = [
  ...
  'ken-mcp/package.json',        // MCP server (private, internal-only)
];
