"""
Ken local benchmark — runs the same 5 tasks against any Ollama model.
No promptfoo required. Compares baseline vs ponytail vs ken on code LOC
...
def load_arms():
    return {
        "baseline": None,
        "ponytail": (ROOT / "benchmarks/arms/ponytail-SKILL.md").read_text(encoding="utf-8"),
        "ken":      (ROOT / "skills/ken/SKILL.md").read_text(encoding="utf-8"),
    }
...
def main():
    parser = argparse.ArgumentParser(description="Ken local benchmark via Ollama")
