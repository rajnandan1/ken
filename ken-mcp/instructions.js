...
const { getKenInstructions } = require("../hooks/ken-instructions.js");
const { getDefaultMode, normalizeMode } = require("../hooks/ken-config.js");
...
// ken: keep the surface to these three; "off"/"review" aren't served here.
...
export function buildInstructions(requested) {
  return getKenInstructions(resolveMode(requested));
}
