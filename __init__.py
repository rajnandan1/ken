...
def _fallback_instructions(mode: str) -> str:
    return (
        ...
        "translates. Before a bug edit, search for the function name and read "
        "every caller; fix inside the shared function. Never paste code you can't explain line by line. Do not "
